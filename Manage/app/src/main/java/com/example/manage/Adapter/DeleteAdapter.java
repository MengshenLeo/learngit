...
public class DeleteAdapter extends RecyclerView.Adapter {
    ...
    public DeleteAdapter(Context context, List<User> list) {
...
//    }
    ...
    public void setOnItemClickListener(DeleteAdapter.onItemClickListener onItemClickListener) {
    ...
    public DeleteViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        DeleteViewHolder holder = new DeleteViewHolder(LayoutInflater.from(mContext).inflate(R.layout.add_item, viewGroup, false));
        return holder;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        DeleteViewHolder vh = ( DeleteViewHolder) holder;
